...
const SignUp = ({ route }) => {
  ...
  return (
    ...
    >
      ...
      >
        <TextComponent
          text={isAd ? 'Signup as Advertiser' : 'Signup as Mobility Partner'}
      ...
      {isAd ? (
        <View style={{ marginTop: Metrix.VerticalSize(10) }}>
          ...
          <TextField
            ...
            onChangeText={text => setRepresentativeEmail(text.toLowerCase())}
          />
          ...
          <View style={{ marginVertical: Metrix.VerticalSize(10) }}>
            ...
            <MaskInput
              ...
              onChangeText={(masked, unmasked) => {
                setRepresentativeContact(masked);
              }}
              mask={[
                `(`,
                /[1-9]/,
          ...
          <View style={{ marginVertical: Metrix.VerticalSize(10) }}>
            <Text style={styles.labelText}> Company Contact Number* </Text>
            <MaskInput
