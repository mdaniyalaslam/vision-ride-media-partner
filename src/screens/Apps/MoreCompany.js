  ...
  const arr = [
    ...
    },
    {
      ...
      goto: () => {
        props.navigation.navigate('WebViewScreen', {
          title: 'Our Brand',
          url: 'https://favorauction.com/page/our-brand',
        });
      },
    },
    {
      ...
      goto: () => {
        props.navigation.navigate('WebViewScreen', {
          title: 'Buyer Terms & Conditions',
          url: 'https://favorauction.com/page/buyers-terms-conditions',
        });
      },
    },
    {
      ...
      goto: () => {
        props.navigation.navigate('WebViewScreen', {
          title: 'Seller Terms & Conditions',
          url: 'https://favorauction.com/page/seller-terms-conditions',
        });
      },
    },
  ];
